    ...
    public static void main(String[] args) {
        ...
        String weather = keyboard.nextLine();
        {
            if (weather.equals("sunny")) {
                out.println("What kind of mood are you in for activities? Choose from exercise, party, or quiet.");
                ...
                if (mood.equals("exercise")) {
                    ...
                    out.println("Oops! Your answer wasn't exercise, party, or quiet. Try again!");
                ...
                out.println("Oops! Your answer wasn't sunny, cloudy, or rainy.  Try again!");
            }
            }
